...
const Counter: React.FC<CounterProps> = ({
  ...
  return (
    <div
      className={cn(
        'button--mutiqty flex items-center justify-between  overflow-hidden flex-shrink-0 ',
        {
    ...
    >
      <button
        ...
        className={cn(
          ...
          {
            'w-8 md:w-12 h-8 rounded text-heading  ms-1':
              variant === 'default',
      ...
      <span
        className={cn(
          'font-semibold flex items-center justify-center transition-colors duration-250 ease-in-out cursor-default flex-shrink-0',
          {
      ...
      <button
        ...
        className={cn(
          ...
          {
            'w-8 md:w-12 h-8 rounded text-heading  me-1':
              variant === 'default',
